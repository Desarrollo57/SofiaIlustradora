...
const telefonoDiseñadora = 573143742159;

//crear funcion usando los inputs
function enviarMensaje(){
    var telefonoDiseñadora = 573143742159;
    ...
    var url = "https://wa.me/" + telefonoDiseñadora + "?text=Hola mi nombre es: " + nombre + " el motivo de mi mensaje es: " + asunto + " los detalles son: " + mensaje + " mi correo es: " + correo;

    window.open(url, '_blank').focus();

    var mensaje = `https://api.whatsapp.com/send?phone=573205254347&text=Hola mi nombre es: ${nombre.value}`;
